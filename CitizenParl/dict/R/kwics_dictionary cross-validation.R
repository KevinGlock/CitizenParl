...
--------------------------------------------
  ## LDA-Topic modelling Staatsb�rgerschaft (erste 300 Begriffe des Topics)
--------------------------------------------
...
## Diktion�rsbegriffe (statistisch)
...
## Begriffe die nicht im Diktion�r enthalten sind m�ssen per Kollokationen validiert werden
...
## Ambiguit�t, Methaphern und interkontextuelle Begriffe
...
## Bezugsbegriffe zu Staatsb�rgerschaft (Substantive)
...
## Verben, Adjektive, Personalpronommen, Adverben
