## total immigration rate statistics from 1991 to 2016 and time series plots of dictionaries


## total immigration to Germany from 1991 to 2016
## from 1991 until 1995 obout one million
## after 1995 decreased
## increased after 2012; a second time above one million
...
## realtive frequencies from dictionaries
...
q_add <- c('".*[Aa]syl.*"', '".*[Ff]l(u|ü)cht.*"', '".*[Mm]igra.*"', '".*[Ee]in.*wander.*"', 
        ...
        '".*[Aa]b.*sch(ie|ob).*"', '".*[Ee]in.*bürger.*"', '".*[Aa]us.*sied(el|ler).*"', '"Ehegattennachzug"', '"Duldung"',
        '".*[Rr]usslanddeutsch.*"', '"[Aa]ufenthalt.*"', '"Rückführung"', '"Identitätsfeststellung"', '"Vis(a|um).*"', '".*[Aa]usländ.*"',
        '"Rückübernahme.*"', '"Residenzpflicht"', '"Regelanfrage"', '"Vertreibung"', '".*Vertr(ie|ei)b.*"', '"AZR"', '"Aufnahme.*"')
