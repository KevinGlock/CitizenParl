## single query dispersions of dictionary words
...
## single query dispersions of [Ii]us (soli|sangruini) | [Jj]us (soli|sanguinis)
...
# time series plot of [Ii]us [] (soli|sangruini) | [Jj]us (soli|sanguinis)
...
plot.xts(
  ...
  lwd = 3,
  yaxs = "r",
  main = '[Ii]us [] (soli|sangruini) | [Jj]us (soli|sanguinis)')
