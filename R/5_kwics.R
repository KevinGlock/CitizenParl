...
#, left = 25, right = 25, cqp = T, s_attributes = c("lp", "date", "role", "parliamentary_group"), interjection = F)

count(coi, query = '"Ausbürgerungen"')
...
## 3      [Ii]us (soli|sanguinis)
## 4      [Jj]us (soli|sanguinis)
## 5  .*[Ss]taats(an|zu)gehörig.*
## 6 Abstammungs(recht|prinzip).*
